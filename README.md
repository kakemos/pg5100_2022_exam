...
| endpoint                  | request | body in json                                                                                         | authorisation needed | purpose                                                                                                                                                                            |
|---------------------------|---------|------------------------------------------------------------------------------------------------------|----------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| /register                 | POST    | {<br> "email": "`newUser@user`",<br> "password": "password" <br>}                                   | none                 | register a user                                                                                                                                                                    |
| /login                    | POST    | {<br>  "email": "`admin@admin.com`",<br> "password": "admin" <br>}                                 | none                 | login with username and password                                                                                                                                                   |
| /user/1                   | GET     |                                                                                                      | user                 | show user <br>*(1 in endpoint referencing the userId,<br> can be changed other existing id's)*                                                                                    |
| /user/all                 | GET     |                                                                                                      | user                 | show all users                                                                                                                                                                     |
| /shelter/all-animals      | GET     |                                                                                                      | user                 | show all animals                                                                                                                                                                   |
| /shelter/animal/1         | GET     |                                                                                                      | user                 | show one animal <br>*(1 in endpoint referencing animals id,<br> can be changed to other existing id's)*                                                                            |
| /shelter/register-animal  | POST    | {<br>	"name": "Horse",<br>	"type": "cow",<br>	"breed": "big",<br>	"gender": 1,<br>	"age": 5<br>}  | admin                | register a new animal                                                                                                                                                              |
| /shelter/animal/1         | PUT     | {<br>	"name": "Pingu",<br>	"type": "dog",<br>	"breed": "cat",<br>	"gender": 1,<br>	"age": 12<br>} | admin                | update animal info of existing animal<br>*(1 in endpoint referencing animals id,<br> can be changed to other existing id's)*                                                                   |
| /shelter/animal/1         | DELETE  |                                                                                                      | admin                | delete an animal<br>*(1 in endpoint referencing animals id,<br> can be changed to other existing id's)*                                                                            |
| /shelter/animal/1/adopted | PUT     | 2                                                                                                    | admin                | mark an animal as adopted<br>*(1 in endpoint referencing animals id,<br> can be changed to other existing id's)*<br>*(2 in body referencing new owners userId, <br>can be changed to other existing id's)* |
