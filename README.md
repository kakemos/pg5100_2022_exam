...
| /user/1                   | GET     |                                                                                                      | user                 | show user <br>*(1 in endpoint referencing the userId, can be changed other existing id's)*                                                                                    |
| /user/all                 | GET     |                                                                                                      | user                 | show all users                                                                                                                                                                     |
| /shelter/all-animals      | GET     |                                                                                                      | user                 | show all animals                                                                                                                                                                   |
| /shelter/animal/1         | GET     |                                                                                                      | user                 | show one animal <br>*(1 in endpoint referencing animals id, can be changed to other existing id's)*                                                                            |
